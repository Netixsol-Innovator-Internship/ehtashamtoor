...
const CheckUser = () => {
  ...
  return (
    <div
      className={`w-screen h-[88.2vh] flex items-center justify-center bg-no-repeat bg-cover bg-center relative `}
      style={{ backgroundImage: "url(/typeuserBG.jpg)", height: "88.2vh" }}
    >
