          ...
          <div className="overflow-hidden">
            ...
            <div className="flex sm:flex-row gap-2 sm:flex-wrap py-4 flex-col">
              {selectedCategoryFoodItems?.map((foodItem, index) => {
                ...
                return (
                  <div
                    class="  mx-auto bg-white rounded-3xl shadow-xl overflow-hidden"
                    key={foodItem._id}
                  >
                    <div class="min-w-[15rem] w-[15rem] sm:w-[18rem] mx-auto">
                      <img
                        class="h-full w-full"
                      ...
                      <div class="p-4 sm:p-6">
                        ...
                        <p class="text-[#7C7C80] font-[15px] mt-6">
                          Our food is made with choosen methods with extra kick
                          of spices, which are mostly liked by people worldwide
                        </p>
