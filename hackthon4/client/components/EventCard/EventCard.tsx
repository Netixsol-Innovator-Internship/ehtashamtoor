...
const EventCard = ({ event, swiper = false, isbooked, fetchBookings }: any) => {
  ...
  const handleBooking = async (e: any, eventid: string) => {
    if (!userHa) {
      toast.success("Please signin to book events");
      router.push("signin");
      return;
    }
  ...
  return (
    ...
    >
      ...
      <div className={styles.content}>
        <div className={`${styles.heading} relative z-0 sm:z-10`}>
            ...
            <div className="bg-white p-8 rounded-md">
              ...
              <div className="text-center">
                <input
                  ...
                  onChange={(e) => setSelectedTickets(parseInt(e.target.value))}
