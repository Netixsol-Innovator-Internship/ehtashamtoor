...
export class AuthService {
  ...
  async updateUser(
    ...
    try {
      ...
      if (userFound.profilePicture && userFound.profilePicture.imageId) {
        // Delete the old profile picture from Cloudinary
        await this.cloudinaryService.deleteImage(
          userFound.profilePicture.imageId,
        );
      }

      // Update the user's profilePicture field with the new path and imageId
